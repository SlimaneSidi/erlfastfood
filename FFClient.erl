-module(ffclient).
-export([client/2, afficher_menu/1, read_choix/0, choix/3, total/1]).

client(Dest, Commande) ->
    afficher_menu(Commande),
    Choice = read_choix(),
    choix(Dest, Choice, Commande).
